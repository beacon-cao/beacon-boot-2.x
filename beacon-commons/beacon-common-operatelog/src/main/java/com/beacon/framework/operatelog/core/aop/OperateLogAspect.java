package com.beacon.framework.operatelog.core.aop;
...
import com.beacon.framework.operatelog.core.enums.OperateTypeEnum;
import com.beacon.framework.operatelog.core.service.OperateLog;
import com.beacon.framework.operatelog.core.service.OperateLogFrameworkService;
import com.beacon.framework.web.core.util.WebFrameworkUtils;
...
import static com.beacon.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static com.beacon.framework.common.exception.enums.GlobalErrorCodeConstants.SUCCESS;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, Operation operation) throws Throwable {
        ...
        com.beacon.framework.operatelog.core.annotations.OperateLog operateLog = getMethodAnnotation(joinPoint,
                com.beacon.framework.operatelog.core.annotations.OperateLog.class);
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         com.beacon.framework.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
        return around0(joinPoint, operateLog, null);
    }

    private Object around0(ProceedingJoinPoint joinPoint,
                           com.beacon.framework.operatelog.core.annotations.OperateLog operateLog,
