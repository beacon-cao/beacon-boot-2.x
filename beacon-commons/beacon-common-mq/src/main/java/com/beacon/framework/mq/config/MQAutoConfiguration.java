package com.beacon.framework.mq.config;

import cn.hutool.core.map.MapUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.system.SystemUtil;
import com.beacon.framework.common.enums.DocumentEnum;
import com.beacon.framework.mq.core.RedisMQTemplate;
import com.beacon.framework.mq.core.interceptor.RedisMessageInterceptor;
...
//                StreamMessageListenerContainer.create(redisTemplate.getRequiredConnectionFactory(), containerOptions);
    ...
    private static void checkRedisVersion(RedisTemplate<String, ?> redisTemplate) {
        ...
        if (majorVersion < 5) {
            throw new IllegalStateException(StrUtil.format("您当前的 Redis 版本为 {}，小于最低要求的 5.0.0 版本！请参考 {} 文档进行安装。", version, DocumentEnum.REDIS_INSTALL.getUrl()));
        }
    }
