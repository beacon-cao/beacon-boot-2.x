...
import com.beacon.business.bpm.service.definition.BpmTaskAssignRuleService;
...
public class BpmTaskAssignRuleController {
    ...
    @PreAuthorize("@security.hasPermission('bpm:task-assign-rule:query')")
    ...
    @PreAuthorize("@security.hasPermission('bpm:task-assign-rule:create')")
    ...
    @PreAuthorize("@security.hasPermission('bpm:task-assign-rule:update')")
