...
import com.beacon.business.bpm.controller.admin.definition.vo.form.*;
...
import com.beacon.business.bpm.service.definition.BpmFormService;
...
public class BpmFormController {
    ...
    @PreAuthorize("@security.hasPermission('bpm:form:create')")
    ...
    @PreAuthorize("@security.hasPermission('bpm:form:update')")
    ...
    @PreAuthorize("@security.hasPermission('bpm:form:delete')")
    ...
    @PreAuthorize("@security.hasPermission('bpm:form:query')")
