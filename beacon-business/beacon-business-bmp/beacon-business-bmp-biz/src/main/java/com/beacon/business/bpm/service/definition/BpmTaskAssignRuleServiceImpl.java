package com.beacon.business.bpm.service.definition;
...
import com.beacon.framework.common.util.object.ObjectUtils;
import com.beacon.business.bpm.framework.flowable.core.behavior.script.BpmTaskAssignScript;
import com.beacon.framework.flowable.core.util.FlowableUtils;
import com.beacon.business.bpm.controller.admin.definition.vo.rule.BpmTaskAssignRuleCreateReqVO;
import com.beacon.business.bpm.controller.admin.definition.vo.rule.BpmTaskAssignRuleRespVO;
import com.beacon.business.bpm.controller.admin.definition.vo.rule.BpmTaskAssignRuleUpdateReqVO;
import com.beacon.business.bpm.convert.definition.BpmTaskAssignRuleConvert;
import com.beacon.business.bpm.dal.dataobject.definition.BpmTaskAssignRuleDO;
import com.beacon.business.bpm.dal.dataobject.definition.BpmUserGroupDO;
import com.beacon.business.bpm.dal.mysql.definition.BpmTaskAssignRuleMapper;
import com.beacon.business.bpm.enums.definition.BpmTaskAssignRuleTypeEnum;
import com.beacon.business.bpm.enums.DictTypeConstants;
import com.beacon.business.system.api.dept.DeptApi;
import com.beacon.business.system.api.dept.PostApi;
...
import com.beacon.business.system.api.permission.RoleApi;
import com.beacon.business.system.api.user.AdminUserApi;
...
import static com.beacon.business.bpm.enums.ErrorCodeConstants.*;
import static com.beacon.framework.common.exception.util.ServiceExceptionUtil.exception;
import static com.beacon.framework.common.util.collection.CollectionUtils.convertMap;
import static com.beacon.framework.common.util.collection.CollectionUtils.convertSet;
import static com.beacon.framework.common.util.json.JsonUtils.toJsonString;
