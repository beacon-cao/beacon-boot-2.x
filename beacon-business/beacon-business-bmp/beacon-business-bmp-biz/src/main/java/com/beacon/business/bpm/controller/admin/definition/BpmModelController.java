...
import com.beacon.business.bpm.service.definition.BpmModelService;
import com.beacon.framework.common.pojo.CommonResult;
import com.beacon.framework.common.pojo.PageResult;
import com.beacon.framework.common.util.io.IoUtils;
...
public class BpmModelController {
    ...
    @PreAuthorize("@security.hasPermission('bpm:model:query')")
    ...
    @PreAuthorize("@security.hasPermission('bpm:model:create')")
    ...
    @PreAuthorize("@security.hasPermission('bpm:model:update')")
    ...
    @PreAuthorize("@security.hasPermission('bpm:model:import')")
    ...
    @Parameter(name = "id", description = "编号", required = true, example = "1024")
    @PreAuthorize("@security.hasPermission('bpm:model:deploy')")
    ...
    @Parameter(name = "id", description = "编号", required = true, example = "1024")
    @PreAuthorize("@security.hasPermission('bpm:model:delete')")
