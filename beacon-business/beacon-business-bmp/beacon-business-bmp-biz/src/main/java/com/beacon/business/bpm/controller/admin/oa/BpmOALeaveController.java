package com.beacon.business.bpm.controller.admin.oa;
...
public class BpmOALeaveController {
    ...
    @PostMapping("/create")
    @PreAuthorize("@security.hasPermission('bpm:oa-leave:create')")
    ...
    @GetMapping("/get")
    @PreAuthorize("@security.hasPermission('bpm:oa-leave:query')")
