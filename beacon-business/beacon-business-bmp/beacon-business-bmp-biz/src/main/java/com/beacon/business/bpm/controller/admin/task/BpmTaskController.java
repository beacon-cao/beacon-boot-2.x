...
import com.beacon.business.bpm.controller.admin.task.vo.task.*;
import com.beacon.business.bpm.service.task.BpmTaskService;
...
import static com.beacon.framework.web.core.util.WebFrameworkUtils.getLoginUserId;
...
public class BpmTaskController {
    ...
    @PreAuthorize("@security.hasPermission('bpm:task:query')")
    ...
    @PreAuthorize("@security.hasPermission('bpm:task:update')")
