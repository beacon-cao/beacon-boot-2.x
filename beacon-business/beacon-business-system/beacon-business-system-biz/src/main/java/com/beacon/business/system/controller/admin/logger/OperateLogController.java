package com.beacon.business.system.controller.admin.logger;
...
import com.beacon.business.system.controller.admin.logger.vo.operatelog.OperateLogExcelVO;
import com.beacon.business.system.controller.admin.logger.vo.operatelog.OperateLogExportReqVO;
import com.beacon.business.system.controller.admin.logger.vo.operatelog.OperateLogPageReqVO;
import com.beacon.business.system.controller.admin.logger.vo.operatelog.OperateLogRespVO;
import com.beacon.business.system.convert.logger.OperateLogConvert;
import com.beacon.business.system.dal.dataobject.logger.OperateLogDO;
...
public class OperateLogController {
    ...
    @PreAuthorize("@security.hasPermission('system:operate-log:query')")
    ...
    @GetMapping("/export")
    @PreAuthorize("@security.hasPermission('system:operate-log:export')")
