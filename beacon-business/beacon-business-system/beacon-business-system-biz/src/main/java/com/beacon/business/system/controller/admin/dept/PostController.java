package com.beacon.business.system.controller.admin.dept;

import com.beacon.business.system.controller.admin.dept.vo.post.*;
...
public class PostController {
    ...
    @PreAuthorize("@security.hasPermission('system:post:create')")
    ...
    @PreAuthorize("@security.hasPermission('system:post:update')")
    ...
    @PreAuthorize("@security.hasPermission('system:post:delete')")
    ...
    @PreAuthorize("@security.hasPermission('system:post:query')")
    ...
    @PreAuthorize("@security.hasPermission('system:post:export')")
