...
import com.beacon.business.system.controller.admin.dept.vo.dept.*;
...
public class DeptController {
    ...
    @PreAuthorize("@security.hasPermission('system:dept:create')")
    ...
    @PreAuthorize("@security.hasPermission('system:dept:update')")
    ...
    @PreAuthorize("@security.hasPermission('system:dept:delete')")
    ...
    @PreAuthorize("@security.hasPermission('system:dept:query')")
