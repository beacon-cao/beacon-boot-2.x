...
import com.beacon.business.system.convert.permission.MenuConvert;
import com.beacon.business.system.dal.dataobject.permission.MenuDO;
import com.beacon.business.system.service.permission.MenuService;
import com.beacon.business.system.controller.admin.permission.vo.menu.*;
...
public class MenuController {
    ...
    @PreAuthorize("@security.hasPermission('system:menu:create')")
    ...
    @PreAuthorize("@security.hasPermission('system:menu:update')")
    ...
    @PreAuthorize("@security.hasPermission('system:menu:delete')")
    ...
    @PreAuthorize("@security.hasPermission('system:menu:query')")
