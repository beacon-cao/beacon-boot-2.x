...
import com.beacon.business.system.controller.admin.oauth2.vo.client.OAuth2ClientCreateReqVO;
import com.beacon.business.system.controller.admin.oauth2.vo.client.OAuth2ClientPageReqVO;
import com.beacon.business.system.controller.admin.oauth2.vo.client.OAuth2ClientRespVO;
import com.beacon.business.system.controller.admin.oauth2.vo.client.OAuth2ClientUpdateReqVO;
import com.beacon.business.system.convert.auth.OAuth2ClientConvert;
...
public class OAuth2ClientController {
    ...
    @PreAuthorize("@security.hasPermission('system:oauth2-client:create')")
    ...
    @PreAuthorize("@security.hasPermission('system:oauth2-client:update')")
    ...
    @PreAuthorize("@security.hasPermission('system:oauth2-client:delete')")
    ...
    @PreAuthorize("@security.hasPermission('system:oauth2-client:query')")
