package com.beacon.business.system.controller.admin.errorcode;
...
import com.beacon.business.system.controller.admin.errorcode.vo.*;
import com.beacon.business.system.convert.errorcode.ErrorCodeConvert;
import com.beacon.business.system.dal.dataobject.errorcode.ErrorCodeDO;
import com.beacon.business.system.service.errorcode.ErrorCodeService;
...
public class ErrorCodeController {
    ...
    @PreAuthorize("@security.hasPermission('system:error-code:create')")
    ...
    @PreAuthorize("@security.hasPermission('system:error-code:update')")
    ...
    @PreAuthorize("@security.hasPermission('system:error-code:delete')")
    ...
    @PreAuthorize("@security.hasPermission('system:error-code:query')")
    ...
    @PreAuthorize("@security.hasPermission('system:error-code:export')")
