package com.beacon.business.system.controller.admin.dict;
...
import com.beacon.business.system.service.dict.DictDataService;
import com.beacon.business.system.controller.admin.dict.vo.data.*;
...
public class DictDataController {
    ...
    @PreAuthorize("@security.hasPermission('system:dict:create')")
    ...
    @PreAuthorize("@security.hasPermission('system:dict:update')")
    ...
    @PreAuthorize("@security.hasPermission('system:dict:delete')")
    ...
    @PreAuthorize("@security.hasPermission('system:dict:query')")
    ...
    @PreAuthorize("@security.hasPermission('system:dict:export')")
