...
import com.beacon.business.system.convert.auth.OAuth2TokenConvert;
...
public class OAuth2TokenController {
    ...
    @PreAuthorize("@security.hasPermission('system:oauth2-token:page')")
    ...
    @PreAuthorize("@security.hasPermission('system:oauth2-token:delete')")
