package com.beacon.business.system.controller.admin.notify;

import com.beacon.framework.common.pojo.CommonResult;
import com.beacon.framework.common.pojo.PageResult;
import com.beacon.business.system.convert.notify.NotifyTemplateConvert;
import com.beacon.business.system.dal.dataobject.notify.NotifyTemplateDO;
import com.beacon.business.system.service.notify.NotifySendService;
import com.beacon.business.system.service.notify.NotifyTemplateService;
import com.beacon.business.system.controller.admin.notify.vo.template.*;
...
public class NotifyTemplateController {
    ...
    @PreAuthorize("@security.hasPermission('system:notify-template:create')")
    ...
    @PreAuthorize("@security.hasPermission('system:notify-template:update')")
    ...
    @PreAuthorize("@security.hasPermission('system:notify-template:delete')")
    ...
    @PreAuthorize("@security.hasPermission('system:notify-template:query')")
    ...
    @PreAuthorize("@security.hasPermission('system:notify-template:send-notify')")
