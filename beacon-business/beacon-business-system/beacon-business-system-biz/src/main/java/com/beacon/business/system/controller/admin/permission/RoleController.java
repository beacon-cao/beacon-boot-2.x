...
import com.beacon.business.system.controller.admin.permission.vo.role.*;
...
public class RoleController {
    ...
    @PreAuthorize("@security.hasPermission('system:role:create')")
    ...
    @PreAuthorize("@security.hasPermission('system:role:query')")
    ...
    @PreAuthorize("@security.hasPermission('system:role:export')")
