...
import com.beacon.business.system.controller.admin.logger.vo.loginlog.LoginLogExcelVO;
...
import com.beacon.business.system.controller.admin.logger.vo.loginlog.LoginLogRespVO;
...
public class LoginLogController {
    ...
    @PreAuthorize("@security.hasPermission('system:login-log:query')")
    ...
    @PreAuthorize("@security.hasPermission('system:login-log:export')")
