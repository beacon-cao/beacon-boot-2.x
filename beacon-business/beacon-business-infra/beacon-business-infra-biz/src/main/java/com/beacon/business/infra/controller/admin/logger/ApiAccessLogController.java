...
import com.beacon.business.infra.service.logger.ApiAccessLogService;
...
public class ApiAccessLogController {
    ...
    @PreAuthorize("@security.hasPermission('infra:api-access-log:query')")
    ...
    @PreAuthorize("@security.hasPermission('infra:api-access-log:export')")
