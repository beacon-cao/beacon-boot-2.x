package com.beacon.business.infra.websocket;
    ...
    public static String getParam(@NotNull String key, Session session) {
        ...
        if (MapUtil.isNotEmpty(parameters)) {
            ...
            if (!StrUtil.isEmpty(queryString)) {
                ...
                List<String> params = StrUtil.split(queryString, '&');
                for (String paramPair : params) {
                    List<String> nameValues = StrUtil.split(queryString, '=');
                    if (key.equals(nameValues.get(0))) {
                        value = nameValues.get(1);
                    }
                }
            }
        }
