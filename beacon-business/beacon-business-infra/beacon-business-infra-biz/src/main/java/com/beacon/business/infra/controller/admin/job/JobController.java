package com.beacon.business.infra.controller.admin.job;
...
import com.beacon.framework.quartz.core.util.CronUtils;
import com.beacon.business.infra.controller.admin.job.vo.job.*;
import com.beacon.business.infra.convert.job.JobConvert;
import com.beacon.business.infra.dal.dataobject.job.JobDO;
import com.beacon.business.infra.service.job.JobService;
...
public class JobController {
    ...
    @PreAuthorize("@security.hasPermission('infra:job:create')")
    ...
    @PreAuthorize("@security.hasPermission('infra:job:update')")
    ...
    @Parameter(name = "id", description = "编号", required = true, example = "1024")
	@PreAuthorize("@security.hasPermission('infra:job:delete')")
    ...
    @Parameter(name = "id", description = "编号", required = true, example = "1024")
    @PreAuthorize("@security.hasPermission('infra:job:trigger')")
    ...
    @Parameter(name = "id", description = "编号", required = true, example = "1024")
    @PreAuthorize("@security.hasPermission('infra:job:query')")
    ...
    @PreAuthorize("@security.hasPermission('infra:job:export')")
