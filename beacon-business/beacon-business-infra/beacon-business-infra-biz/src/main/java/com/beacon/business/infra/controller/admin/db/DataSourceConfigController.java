package com.beacon.business.infra.controller.admin.db;

import com.beacon.framework.common.pojo.CommonResult;
import com.beacon.business.infra.controller.admin.db.vo.DataSourceConfigCreateReqVO;
import com.beacon.business.infra.controller.admin.db.vo.DataSourceConfigRespVO;
import com.beacon.business.infra.controller.admin.db.vo.DataSourceConfigUpdateReqVO;
import com.beacon.business.infra.convert.db.DataSourceConfigConvert;
import com.beacon.business.infra.dal.dataobject.db.DataSourceConfigDO;
import com.beacon.business.infra.service.db.DataSourceConfigService;
...
public class DataSourceConfigController {
    ...
    @PreAuthorize("@security.hasPermission('infra:data-source-config:create')")
    ...
    @PreAuthorize("@security.hasPermission('infra:data-source-config:update')")
    ...
    @PreAuthorize("@security.hasPermission('infra:data-source-config:delete')")
    ...
    @PreAuthorize("@security.hasPermission('infra:data-source-config:query')")
