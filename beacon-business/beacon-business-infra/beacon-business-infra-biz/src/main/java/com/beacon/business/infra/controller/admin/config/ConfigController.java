package com.beacon.business.infra.controller.admin.config;
...
import com.beacon.business.infra.controller.admin.config.vo.*;
import com.beacon.business.infra.convert.config.ConfigConvert;
import com.beacon.business.infra.dal.dataobject.config.ConfigDO;
import com.beacon.business.infra.enums.ErrorCodeConstants;
import com.beacon.business.infra.service.config.ConfigService;
...
public class ConfigController {
    ...
    @PreAuthorize("@security.hasPermission('infra:config:create')")
    ...
    @PreAuthorize("@security.hasPermission('infra:config:update')")
    ...
    @PreAuthorize("@security.hasPermission('infra:config:delete')")
    ...
    @Parameter(name = "id", description = "编号", required = true, example = "1024")
    @PreAuthorize("@security.hasPermission('infra:config:query')")
    ...
    @Parameter(name = "key", description = "参数键", required = true, example = "beacon.biz.username")
    ...
    @PreAuthorize("@security.hasPermission('infra:config:export')")
