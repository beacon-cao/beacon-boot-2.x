package com.beacon.business.infra.controller.admin.file;
...
import com.beacon.business.infra.service.file.FileConfigService;
...
public class FileConfigController {
    ...
    @PreAuthorize("@security.hasPermission('infra:file-config:create')")
    ...
    @PreAuthorize("@security.hasPermission('infra:file-config:update')")
    ...
    @PreAuthorize("@security.hasPermission('infra:file-config:delete')")
    ...
    @PreAuthorize("@security.hasPermission('infra:file-config:query')")
