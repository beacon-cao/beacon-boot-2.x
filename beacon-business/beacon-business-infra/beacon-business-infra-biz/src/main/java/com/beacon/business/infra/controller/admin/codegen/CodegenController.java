package com.beacon.business.infra.controller.admin.codegen;
...
import com.beacon.business.infra.controller.admin.codegen.vo.CodegenCreateListReqVO;
import com.beacon.business.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import com.beacon.business.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
import com.beacon.business.infra.controller.admin.codegen.vo.CodegenUpdateReqVO;
import com.beacon.business.infra.controller.admin.codegen.vo.table.CodegenTablePageReqVO;
import com.beacon.business.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import com.beacon.business.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.beacon.business.infra.convert.codegen.CodegenConvert;
import com.beacon.business.infra.dal.dataobject.codegen.CodegenColumnDO;
import com.beacon.business.infra.dal.dataobject.codegen.CodegenTableDO;
import com.beacon.business.infra.service.codegen.CodegenService;
...
public class CodegenController {
    ...
    @PreAuthorize("@security.hasPermission('infra:codegen:query')")
    ...
    @PreAuthorize("@security.hasPermission('infra:codegen:create')")
    ...
    @PutMapping("/update")
    @PreAuthorize("@security.hasPermission('infra:codegen:update')")
    ...
    @Parameter(name = "tableId", description = "表编号", required = true, example = "1024")
    @PreAuthorize("@security.hasPermission('infra:codegen:delete')")
    ...
    @GetMapping("/preview")
    @Parameter(name = "tableId", description = "表编号", required = true, example = "1024")
    @PreAuthorize("@security.hasPermission('infra:codegen:preview')")
