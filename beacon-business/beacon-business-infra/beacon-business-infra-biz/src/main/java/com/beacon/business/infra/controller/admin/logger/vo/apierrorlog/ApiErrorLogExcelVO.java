package com.beacon.business.infra.controller.admin.logger.vo.apierrorlog;

import com.beacon.framework.excel.core.annotations.DictFormat;
import com.beacon.framework.excel.core.convert.DictConvert;
import com.beacon.business.infra.enums.DictTypeConstants;
...
public class ApiErrorLogExcelVO {
    ...
    @DictFormat(com.beacon.business.system.enums.DictTypeConstants.USER_TYPE)
