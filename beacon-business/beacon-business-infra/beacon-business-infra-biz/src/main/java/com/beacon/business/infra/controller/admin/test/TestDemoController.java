package com.beacon.business.infra.controller.admin.test;
...
import com.beacon.business.infra.controller.admin.test.vo.*;
import com.beacon.business.infra.convert.test.TestDemoConvert;
import com.beacon.business.infra.dal.dataobject.test.TestDemoDO;
import com.beacon.business.infra.service.test.TestDemoService;
...
public class TestDemoController {
    ...
    @PreAuthorize("@security.hasPermission('infra:test-demo:create')")
    ...
    @PreAuthorize("@security.hasPermission('infra:test-demo:update')")
    ...
    @PreAuthorize("@security.hasPermission('infra:test-demo:delete')")
    ...
    @PreAuthorize("@security.hasPermission('infra:test-demo:query')")
    ...
    @PreAuthorize("@security.hasPermission('infra:test-demo:query')")    public CommonResult<PageResult<TestDemoRespVO>> getTestDemoPage(@Valid TestDemoPageReqVO pageVO) {
    ...
    @PreAuthorize("@security.hasPermission('infra:test-demo:export')")    @OperateLog(type = EXPORT)
